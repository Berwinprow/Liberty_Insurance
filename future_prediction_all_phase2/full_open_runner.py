...
# ======================================================
# FULL TRAIN + OPEN PREDICTION RUNNER
# ======================================================
def run_full_open_prediction(
    ...
    """
    STRICT FULL TRAIN + OPEN PREDICTION RUNNER
    ...
    # ======================================================
        ...
        if model_cfg["type"] == "single":
            ...
            if model_cfg["method"] == "soft_voting":
                ...
                y_op_prob = model.predict_proba((X_open, X_open))[:, 1]
    ...
    # ================= TRAIN METRICS =================
    train_m = compute_train_metrics(
        y_train, y_tr_prob, threshold
    )
