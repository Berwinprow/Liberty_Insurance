...
def run_future_pipeline():
    ...
    logger.info(" FUTURE PREDICTION PIPELINE STARTED")
    ...
    for feature_set in feature_sets:
        ...
        for split_name in ["80_20", "70_30", "time_based", "full"]:
            ...
            logger.info(" SPLIT=%s | MODE=%s", split_name, mode)
    ...
    logger.info(" FUTURE PREDICTION PIPELINE COMPLETED SUCCESSFULLY")
