"""
Cross-validation runner for future prediction pipeline (Phase-2).

Supports:
- Single models
- Ensemble models
- 7-set undersampling logic
...
from future_prediction_all_phase2.single_model_library import (
    create_single_model,
)
...
from future_prediction_all_phase2.threshold_optimizer import (
    apply_threshold,
)
...
def compute_metrics(y_true, y_prob, threshold):
    ...
    return {
        ...
        "precision_class0": precision_score(
            y_true,
            y_pred,
            pos_label=0,
        ),
...
def run_cross_validation(
    ...
    """
    Strict cross-validation runner.

    Notes:
    - Threshold must be a scalar in model_cfg["threshold"]
    - Orchestrator handles threshold lists externally
    """
    # ================= SAFETY =================
